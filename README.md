# Unity场景切换器 (Unity Scene Switcher)

这是一款基于[unity-toolbar-extender](https://github.com/marijnz/unity-toolbar-extender/tree/master)开发的场景切换器，用于在编辑器上快速切换场景
* 自由配置多个场景
* 退出运行时停留在当前场景
* 直接运行指定高频场景
...
* Launch a frequently used scene directly
